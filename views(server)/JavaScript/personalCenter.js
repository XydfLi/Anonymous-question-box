$(document).ready(function(){
    ...
    $("#activeAccountButton").click(function(){
        ...
        $.ajax({
            url:"http://39.101.199.3:8080/myProj-1.0-SNAPSHOT/1.0/users/emailUri",
            type:"POST",
            cache:false,
    ...
    function getAccountName(){
        ...
        $.ajax({
            url:"http://39.101.199.3:8080/myProj-1.0-SNAPSHOT/1.0/users/getAccountName",
            type:"GET",
            cache:false,
    ...
    function getAvatar(){
        ...
        if(accountName!="visitor"){
            el.src="http://39.101.199.3:8080/myProj-1.0-SNAPSHOT/1.0/users/getAvatar/"+accountName;
        }
    ...
    $("#updateAccountNameButton").click(function(){
        ...
        $.ajax({
            url:"http://39.101.199.3:8080/myProj-1.0-SNAPSHOT/1.0/users/account",
            type:"PUT",
            cache:false,
            data:JSON.stringify(data),
            dataType:"json",
    ...
    $("#openQ").click(function(){
        ...
        $.ajax({
            url:"http://39.101.199.3:8080/myProj-1.0-SNAPSHOT/1.0/users/questionBoxStatus/1",
            type:"PUT",
            cache:false,
            // data:JSON.stringify(data),
            dataType:"json",
    ...
    $("#closeQ").click(function(){
        ...
        $.ajax({
            url:"http://39.101.199.3:8080/myProj-1.0-SNAPSHOT/1.0/users/questionBoxStatus/0",
            type:"PUT",
            cache:false,
            // data:JSON.stringify(data),
            dataType:"json",
    ...
    $("#upload").click(function(){
        ...
        url="http://39.101.199.3:8080/myProj-1.0-SNAPSHOT/1.0/users/avatar";
        $.ajax({
            url: url,
            type: "POST",
            data: formData,
