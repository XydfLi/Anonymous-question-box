$(document).ready(function(){
    ...
    $(document).on('click','.cAns',function(){
        ...
        $("#myansButton").click(function(){
            ...
            let url="http://localhost:8080/1.0/answerBox/answer/"+questionId; 
            subAns(url,cont);
        });
    });
    ...
    $(document).on('click','.tipQ',function(){
        ...
        let url="http://localhost:8080/1.0/action/tipOff/"+questionId;
    ...
    $(document).on('click','.blackQ',function(){
        ...
        let url="http://localhost:8080/1.0/action/black/"+questionId;
    ...
    $(document).on('click','.cancelQuesD',function(){
        ...
        let url="http://localhost:8080/1.0/answerBox/answer/"+questionId+"/2";
    ...
    $(document).on('click','.quesD',function(){
        ...
        let url="http://localhost:8080/1.0/answerBox/answer/"+questionId+"/1";
    ...
    $("#BlackQ").click(function(){
        ...
        $.ajax({
            url:"http://localhost:8080/1.0/action/black",
            type:"GET",
            cache:false,
            // data:JSON.stringify(questionBox),
            // dataType:"json",
    ...
    $("#QuestionY").click(function(){
        ...
        $.ajax({
            url:"http://localhost:8080/1.0/answerBox/answer/Y",
            type:"GET",
            cache:false,
            // data:JSON.stringify(questionBox),
            // dataType:"json",
    ...
    $("#QuestionN").click(function(){
        ...
        $.ajax({
            url:"http://localhost:8080/1.0/answerBox/answer/N",
            type:"GET",
            cache:false,
            // data:JSON.stringify(questionBox),
            // dataType:"json",
    ...
    $("#QuestionD").click(function(){
        ...
        $.ajax({
            url:"http://localhost:8080/1.0/answerBox/answer/D",
            type:"GET",
            cache:false,
            // data:JSON.stringify(questionBox),
            // dataType:"json",
    ...
    $("#ansQuestion").click(function(){
        ...
        $.ajax({
            url:"http://localhost:8080/1.0/questionBox/question/ans",
            type:"GET",
            cache:false,
            // data:JSON.stringify(questionBox),
            // dataType:"json",
    ...
    $("#createQuestionButton").click(function(){
        ...
        //创建提问
        $.ajax({
            url:"http://localhost:8080/1.0/questionBox/question",
            type:"POST",
            cache:false,
            data:JSON.stringify(questionBox),
            dataType:"json",
    ...
    function createAnswer(flag,accountName,questionId){
        ...
        let url="";
        if(flag){
            url="http://localhost:8080/1.0/answerBox/answer/"+questionId+"/1";
        } else {
            url="http://localhost:8080/1.0/answerBox/answer/"+questionId+"/0";
        }
    ...
    function questionBoxIsOpen(){
        $('#ansQuesDetail').fadeOut(10);
        $.ajax({
            url:"http://localhost:8080/1.0/questionBox/questionBoxState",
            type:"GET",
            dataType:"json",
            cache:false,
            crossDomain:true,
