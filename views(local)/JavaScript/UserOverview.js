$(document).ready(function(){
    ...
    $("#cancelBan").click(function(){
        ...
        let url="";
        if((accountName.val()!=null)&&(accountName.val()!="")&&(accountName.val())){
            url="http://localhost:8080/1.0/action/ban/"+accountName.val()+"/1";
        } else {
            url="http://localhost:8080/1.0/action/ban/"+email.val()+"/2";
        }
    ...
    function subminQ(accountName,email){
        ...
        if((accountName!=null)&&(accountName!="")&&(accountName)){
            url="http://localhost:8080/1.0/users/accountQInfo/"+accountName+"/1";
        } else {
            url="http://localhost:8080/1.0/users/accountQInfo/"+email+"/2";
        }
    ...
    $(document).on('click','.tipOffA',function(){
        ...
        let url="http://localhost:8080/1.0/action/ban/"+questionId+"/1";
    ...
    $("#AllAccount").click(function(){
        ...
        $.ajax({
            url:"http://localhost:8080/1.0/users/accountInfo",
            type:"GET",
            cache:false,
            // data:JSON.stringify(questionBox),
            // dataType:"json",
